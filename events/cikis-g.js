...
module.exports = async member => {  
 ...
 ctx.beginPath();
  ...
  const attachment = new Discord.Attachment(canvas.toBuffer(), 'vortex.png');
 ...
 const embed = new Discord.RichEmbed()
      ...
      .setDescription(
        `<a:mavi:690267134261329950> ${member.user.username} Adlı Gold üye Ayrıldı. <a:mavi:690267134261329950>`
      );
